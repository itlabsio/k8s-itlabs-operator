...
from connectors.keycloak_connector.factories.crd_factory import (
    KeycloakConnectorCrdFactory,
)
from connectors.keycloak_connector.factories.dto_factory import (
    KeycloakConnectorFactory,
)
...
class KubernetesService(AbstractKubernetesService):
    ...
    def get_keycloak_connector(cls, name: str) -> Optional[KeycloakConnector]:
        ...
        kk_connector_crd = KeycloakConnectorCrdFactory.crd_from_dict(
            kk_connector_obj
        )
        return KeycloakConnectorFactory.dto_from_kk_connector_crd(
            kk_connector_crd
        )
