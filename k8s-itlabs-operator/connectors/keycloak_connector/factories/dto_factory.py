...
class KeycloakConnectorFactory:
    @staticmethod
    def dto_from_kk_connector_crd(
        kk_connector_crd: KeycloakConnectorCrd,
    ) -> KeycloakConnector:
...
class KeycloakApiSecretDtoFactory:
    ...
    def api_secret_dto_from_connector(
        cls, kk_connector: KeycloakConnector
    ) -> KeycloakApiSecretDto:
