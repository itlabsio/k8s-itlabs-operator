...
from connectors.rabbit_connector.factories.crd_factory import (
    RabbitConnectorCrdFactory,
)
from connectors.rabbit_connector.factories.dto_factory import (
    RabbitConnectorFactory,
)
...
class KubernetesService(AbstractKubernetesService):
    ...
    def get_rabbit_connector(cls, name: str) -> Optional[RabbitConnector]:
        ...
        rabbit_conn_crd = RabbitConnectorCrdFactory.crd_from_dict(
            rabbit_conn_obj
        )
