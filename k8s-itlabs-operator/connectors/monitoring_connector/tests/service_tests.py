...
class TestMonitoringConnectorService:
    def test_is_monitoring_connector_used_by_object_not_used(self):
        is_used = MonitoringConnectorService.is_monitoring_connector_used_by_object(annotations={})
        assert not is_used
    ...
    def test_is_monitoring_connector_used_by_object_not_used_turned_of(self):
        ...
        is_used = MonitoringConnectorService.is_monitoring_connector_used_by_object(annotations=annotations)
        assert not is_used
