...
from connectors.sentry_connector.factories.crd_factory import (
    SentryConnectorCrdFactory,
)
from connectors.sentry_connector.factories.dto_factory import (
    SentryConnectorFactory,
)
...
class KubernetesService(AbstractKubernetesService):
    ...
    def get_sentry_connector(cls, name: str) -> Optional[SentryConnector]:
        ...
        sentry_connector_crd = SentryConnectorCrdFactory.crd_from_dict(
            sentry_connector_obj
        )
        return SentryConnectorFactory.dto_from_sentry_connector_crd(
            sentry_connector_crd
        )
