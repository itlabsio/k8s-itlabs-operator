...
class TestSentryConnectorMicroserviceDtoFactory:
    def test_annotation_contain_transform_environment_value(self):
        ...
        annotations = {
            x: "value"
            for x in specifications.SENTRY_CONNECTOR_REQUIRED_ANNOTATIONS
        }
        annotations[specifications.SENTRY_ENVIRONMENT_ANNOTATION] = (
            "development"
        )
    ...
    def test_all_annotations_exists(self):
        annotations = {
            key: "value" for key in specifications.SENTRY_CONNECTOR_ANNOTATIONS
        }
        labels = {}
        connector_dto = (
    ...
    def test_required_annotations_and_label_for_default_value_exists(self):
        annotations = {
            key: "value"
            for key in specifications.SENTRY_CONNECTOR_REQUIRED_ANNOTATIONS
        }
