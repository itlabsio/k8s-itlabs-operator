...
from connectors.atlas_connector.services.atlas_connector import (
    AtlasConnectorService,
)
...
def create_pods(annotations, namespace, **kwargs):
    ...
    atlas_annotations = AtlasConnectorAnnotationsFactory.annotations_from_dict(
        data=annotations
    )
    return AtlasConnectorService.on_upsert_pod(
        namespace=namespace, annotations=atlas_annotations
    )
